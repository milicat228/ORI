                ...
                for (int j = 0; j < Main.brojKolona; j++)
                {
                    ...
                    switch (tt)
                    {
                        ...
                        case 3:
                            ...
                            break;
                        //TODO 1.1: Dodati obavezno polje - oruzje za Bonda, alkohol za Milosa, mocvara polja za Bonda, kantu za Milosa, i dzip i senzor (Jelenu) i cvece (dugme)
                        case 4:
                        ...
                        case 8:
                            ...
                            gr.DrawImage(cvece, dx * j + dx / 2 - cvece.Width / 2, dy * i + dy / 2 - cvece.Height / 2);
                            break;
                    }
