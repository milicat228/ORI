...
namespace Lavirint
{
    public partial class DisplayPanel : UserControl
    {
        public DisplayPanel()
        {
            ...
            icon = Properties.Resources.meda;
            pancake = Properties.Resources.pancakes;
            beer = Properties.Resources.beer;
            books = Properties.Resources.books;
            diploma = Properties.Resources.diploma;
        }
                ...
                for (int j = 0; j < Main.brojKolona; j++)
                {
                    ...
                    switch (tt)
                    {
                        ...
                        case 3:
                            ...
                            gr.DrawImage(diploma, dx * j + dx / 2 - diploma.Width / 2, dy * i + dy / 2 - diploma.Height / 2);
                            break;
                        //TODO 1.1: Prosiriti tako da se mogu dodati i plave i narandzaste kutije i vatra
                        case 4:
                            cc2 = Color.FromArgb(100, Color.Blue);
                            gr.DrawImage(pancake, dx * j + dx / 2 - pancake.Width / 2, dy * i + dy / 2 - pancake.Height / 2);
                            break;
                        case 5:
                            cc2 = Color.FromArgb(100, Color.Orange);
                            gr.DrawImage(beer, dx * j + dx / 2 - beer.Width / 2, dy * i + dy / 2 - beer.Height / 2);
                            break;
                        case 6:
                            cc2 = Color.FromArgb(100, Color.IndianRed);
                            gr.DrawImage(books, dx * j + dx / 2 - books.Width / 2, dy * i + dy / 2 - books.Height / 2);
                            break;
                    }
        ...
        protected override void OnMouseDown(MouseEventArgs e)
        {
            ...
            switch (tt)
            {
                ...
                case 3:
                    tt = 4;
                    break;
                //TODO 1.2: Prosiriti za plave i narandzaste kutije i vatra polja
                case 4:
                    tt = 5;
                    break;
                case 5:
