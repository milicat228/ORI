...
namespace Lavirint
{
    public partial class DisplayPanel : UserControl
    {
        public DisplayPanel()
        {
            ...
            icon = Properties.Resources.mario;
            peach = Properties.Resources.peach;
            coin = Properties.Resources.coin;
            pipe = Properties.Resources.pipe;
            mushroom = Properties.Resources.mushroom;
        }
                ...
                for (int j = 0; j < Main.brojKolona; j++)
                {
                    ...
                    switch (tt)
                    {
                        ...
                        case 3:
                            ...
                            gr.DrawImage(peach, dx * j + dx / 2 - peach.Width / 2, dy * i + dy / 2 - peach.Height / 2);
                            break;
                        //TODO 1.1: Dodati plave i narandzaste kutije i portale (ljubicasta polja)
                        case 4:
                            cc2 = Color.FromArgb(100, Color.DarkBlue);
                            gr.DrawImage(mushroom, dx * j + dx / 2 - mushroom.Width / 2, dy * i + dy / 2 - mushroom.Height / 2);
                            break;
                        case 5:
                            cc2 = Color.FromArgb(100, Color.Orange);
                            gr.DrawImage(coin, dx * j + dx / 2 - coin.Width / 2, dy * i + dy / 2 - coin.Height / 2);
                            break;
                        case 6:
                            cc2 = Color.FromArgb(100, Color.Purple);
                            gr.DrawImage(pipe, dx * j + dx / 2 - pipe.Width / 2, dy * i + dy / 2 - pipe.Height / 2);
                            break;
                    }
                    String ttS = lavirintPoruke[i][j];

                    if( tt == 1 || tt == 2) //ostale namerno necu da bojim, jer imaju slicice, pa je lepse
        ...
        protected override void OnMouseDown(MouseEventArgs e)
        {
            ...
            switch (tt)
            {
                ...
                case 3:
                    tt = 4;
                    break;
                //TODO 1.2: Dodati plave i narandzaste kutije i portale (ljubicasta polja)
                case 4:
                    tt = 5;
                    break;
                case 5:
