...
namespace Lavirint
{
    public partial class DisplayPanel : UserControl
    {
        public DisplayPanel()
        {
            ...
            pancakes = Properties.Resources.palacinke;
            ind = Properties.Resources.sastojci;
        }
                ...
                for (int j = 0; j < Main.brojKolona; j++)
                {
                    ...
                    switch (tt)
                    {
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            cc2 = Color.FromArgb(100, Color.LightPink);
                            gr.DrawImage(pancakes, dx * j + dx / 2 - pancakes.Width / 2, dy * i + dy / 2 - pancakes.Height / 2);
                            break;
                        case 4:
                            //TODO 1.1: Prosiriti tako da se moze dodati polje bez boje -> obavezno polje
                            cc2 = Color.FromArgb(100, Color.Beige);
                            gr.DrawImage(ind, dx * j + dx / 2 - ind.Width / 2, dy * i + dy / 2 - ind.Height / 2);
                            break;
                    }
        ...
        protected override void OnMouseDown(MouseEventArgs e)
        {
            ...
            switch (tt)
            {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    //TODO 1.2: Prosiriti tako da se moze dodati polje bez boje -> obavezno polje
                    tt = 0;
                    break;
            }                    
